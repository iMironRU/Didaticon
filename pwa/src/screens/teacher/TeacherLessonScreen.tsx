...
const s: Record<string, React.CSSProperties> = {
  ...
  header: { display: "flex", alignItems: "center", gap: 10, padding: "12px 16px", borderBottom: "0.5px solid var(--c-border)", background: "var(--c-card)" },
  back:   { background: "none", border: "none", fontSize: "1.5rem", color: "var(--c-accent)", cursor: "pointer", lineHeight: 1, padding: "0 4px" },
  headerInfo: { flex: 1 },
  headerTitle:{ fontSize: "0.95rem", fontWeight: 600, color: "var(--c-text-primary)" },
  headerMeta: { fontSize: "0.75rem", color: "var(--c-text-muted)", marginTop: 2 },
  ...
  section:{ background: "var(--c-card)", borderRadius: 14, padding: "14px" },
  sectionHeader: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 },
  sectionTitle:  { fontSize: "0.82rem", color: "var(--c-text-muted)", fontWeight: 600, textTransform: "uppercase" as const, letterSpacing: "0.04em" },
  absentCount:   { fontSize: "0.78rem", color: "var(--c-danger)", fontWeight: 600 },
  bulkRow:{ display: "flex", gap: 6, marginBottom: 10 },
  bulkBtn:{ flex: 1, background: "var(--c-card)", border: "0.5px solid var(--c-border)", borderRadius: 8, padding: "7px 4px", fontSize: "0.68rem", color: "var(--c-text-muted)", cursor: "pointer" },
  ...
  checkbox:    { fontSize: "0.9rem", color: "var(--c-text-dim)", width: 16, textAlign: "center" as const, flexShrink: 0 },
  checkboxAbsent: { color: "var(--c-danger)" },
  studentName: { fontSize: "0.88rem", color: "var(--c-text-primary)" },
  ...
  tasksBtn:{ width: "100%", background: "var(--c-card)", border: "0.5px solid var(--c-border)", borderRadius: 10, padding: "13px 0", fontSize: "0.88rem", color: "var(--c-text-primary)", cursor: "pointer", marginTop: 10 },
};
