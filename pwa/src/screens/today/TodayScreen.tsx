...
export function TodayScreen({ contextId }: Props) {
  ...
  return (
    <div className="px-4 py-4 space-y-3 md:py-8">
      {/* Читаемая ширина на десктопе задаётся один раз в UnifiedShell (на
          <main>), одинаково для всех вкладок — не дублируем здесь (issue #62,
          потом расширено на все вкладки). */}
